...
function validateAnswerInputs() {
    ...
    for (let i = 1; i <= quizzQuestionNum; i++) {
        ...
        let answerBackground = document.querySelector(`#questionBackground${i}`).value;
        let answerCorrect = document.querySelector(`#answerQuestionCorrect${i}`).value;
        let answerCorrectBackground = document.querySelector(`#answerCorrectBackground${i}`).value;
        ...
        let answerIncorrect1Background = document.querySelector(`#incorrectAnsBg1${i}`).value;
        let answerIncorrect2Background = document.querySelector(`#incorrectAnsBg2${i}`).value;
        let answerIncorrect3Background = document.querySelector(`#incorrectAnsBg3${i}`).value;
        ...
        const isValidAnswerIncorrectText1 = verifyAnswerIncorrectText(answerIncorrect1, i, 1);
        const isValidAnswerIncorrectText2 = verifyAnswerIncorrectText(answerIncorrect2, i, 2);
        const isValidAnswerIncorrectText3 = verifyAnswerIncorrectText(answerIncorrect3, i, 3);
...
function verifyTextCorrectAnswer(answerText, i) {
    const answerQuestionCorrectLabel = document.querySelector(`#answerQuestionCorrectLabel${i}`);
    const answerQuestionCorrectInput = document.querySelector(`#answerQuestionCorrect${i}`);
    if (answerText === "") {
...
function verifyAnswerCorrectBackground(answerCorrectBackground, i) {
    const answerQuestionCorrectLabel = document.querySelector(`#answerCorrectBackgroundLabel${i}`);
    const answerQuestionCorrectInput = document.querySelector(`#answerCorrectBackground${i}`);
...
function verifyAnswerIncorrectBackground(answerIncorrectBackground, i, numQuestion) {
...
function verifyBackgroundAnswer(answerBackground, i) {
    const questionBackgroundLabel = document.querySelector(`#questionBackgroundLabel${i}`);
    const questionBackgroundtInput = document.querySelector(`#questionBackground${i}`);
...
function loadSelectedQuizz(id) {
    ...
    toggleVisibility([quizzListSection, createQuizSection, finishQuizzPage], [cssLoader]);
